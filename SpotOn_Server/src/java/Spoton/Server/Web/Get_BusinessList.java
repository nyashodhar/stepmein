 ...
 */
@WebServlet(name = "Get_BusinessList", urlPatterns = {"/Get_BusinessList"})
public class Get_BusinessList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            xml.concat(Utils.getXML(BusinessListByUser));
