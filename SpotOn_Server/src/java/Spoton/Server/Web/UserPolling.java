 ...
 * @author kunal
 */
@WebServlet(name = "UserPolling", urlPatterns = {"/UserPolling"})
public class UserPolling extends HttpServlet
{

private static SpotOnLogger logger = 
            new SpotOnLogger(UserPolling.class.getName());
...
protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try
            ...
            Hashtable<String, String> inp =
                    XMLParser.parseUserPolling(request.getInputStream());
            
            if(UserCommon.checkActiveSession(inp.get("uName"),
