 ...
 */
@WebServlet(name = "User_ActiveCheckins", urlPatterns = {"/User_ActiveCheckins"})
public class User_ActiveCheckins extends HttpServlet {
    ...
    private static SpotOnLogger logger = 
            new SpotOnLogger(User_ActiveCheckins.class.getName());
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try 
            ...
            if(UserCommon.checkActiveSession(inp.get("userID"), UUID.fromString(inp.get("sessionID"))))
                {
                ArrayList<UserCheckInData> checkInHistory = UserCommon.Get_ActiveCheckIns(userID);
